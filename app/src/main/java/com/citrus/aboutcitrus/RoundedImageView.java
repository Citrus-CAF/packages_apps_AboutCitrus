...
public class RoundedImageView extends ImageView {
  ...
  private ColorStateList mBorderColor =
      ColorStateList.valueOf(com.citrus.aboutcitrus.RoundedDrawable.DEFAULT_BORDER_COLOR);
  ...
  public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    if (mBorderColor == null) {
      mBorderColor = ColorStateList.valueOf(com.citrus.aboutcitrus.RoundedDrawable.DEFAULT_BORDER_COLOR);
    }
  ...
  public void setImageDrawable(Drawable drawable) {
    mResource = 0;
    mDrawable = com.citrus.aboutcitrus.RoundedDrawable.fromDrawable(drawable);
    updateDrawableAttrs();
  ...
  public void setImageBitmap(Bitmap bm) {
    mResource = 0;
    mDrawable = com.citrus.aboutcitrus.RoundedDrawable.fromBitmap(bm);
    updateDrawableAttrs();
    super.setImageDrawable(mDrawable);
  }
  ...
  private Drawable resolveResource() {
    ...
    return com.citrus.aboutcitrus.RoundedDrawable.fromDrawable(d);
  }
  ...
  private void updateBackgroundDrawableAttrs(boolean convert) {
    if (mMutateBackground) {
      if (convert) {
        mBackgroundDrawable = com.citrus.aboutcitrus.RoundedDrawable.fromDrawable(mBackgroundDrawable);
      }
  ...
  private void updateAttrs(Drawable drawable) {
    ...
    if (drawable instanceof com.citrus.aboutcitrus.RoundedDrawable) {
      ((com.citrus.aboutcitrus.RoundedDrawable) drawable)
      ...
      if (mCornerRadii != null) {
        ((com.citrus.aboutcitrus.RoundedDrawable) drawable).setCornerRadius(
            mCornerRadii[com.citrus.aboutcitrus.Corner.TOP_LEFT],
            mCornerRadii[com.citrus.aboutcitrus.Corner.TOP_RIGHT],
            mCornerRadii[com.citrus.aboutcitrus.Corner.BOTTOM_RIGHT],
            mCornerRadii[com.citrus.aboutcitrus.Corner.BOTTOM_LEFT]);
   ...
   * @return the radius.
   */
  public float getCornerRadius(@com.citrus.aboutcitrus.Corner int corner) {
   ...
   */
  public void setCornerRadiusDimen(@com.citrus.aboutcitrus.Corner int corner, @DimenRes int resId) {
   ...
   */
  public void setCornerRadius(@com.citrus.aboutcitrus.Corner int corner, float radius) {
  ...
  public void setCornerRadius(float topLeft, float topRight, float bottomLeft, float bottomRight) {
    if (mCornerRadii[com.citrus.aboutcitrus.Corner.TOP_LEFT] == topLeft
        && mCornerRadii[com.citrus.aboutcitrus.Corner.TOP_RIGHT] == topRight
        && mCornerRadii[com.citrus.aboutcitrus.Corner.BOTTOM_RIGHT] == bottomRight
        && mCornerRadii[com.citrus.aboutcitrus.Corner.BOTTOM_LEFT] == bottomLeft) {
      return;
    }

    mCornerRadii[com.citrus.aboutcitrus.Corner.TOP_LEFT] = topLeft;
    mCornerRadii[com.citrus.aboutcitrus.Corner.TOP_RIGHT] = topRight;
    mCornerRadii[com.citrus.aboutcitrus.Corner.BOTTOM_LEFT] = bottomLeft;
    mCornerRadii[com.citrus.aboutcitrus.Corner.BOTTOM_RIGHT] = bottomRight;
  ...
  public void setBorderColor(ColorStateList colors) {
    ...
    mBorderColor =
        (colors != null) ? colors : ColorStateList.valueOf(com.citrus.aboutcitrus.RoundedDrawable.DEFAULT_BORDER_COLOR);
    updateDrawableAttrs();
    updateBackgroundDrawableAttrs(false);
    if (mBorderWidth > 0) {
      invalidate();
